...
- Physics, consciousness, or universal-framework claims.
- Claims that a classical conjecture is proved.
- Interpretations that do not name a measurable object, range, control, and failure condition.

## Ledger-First Rule

Use `docs/EVIDENCE_LEDGER.md` as the scorecard before adding experiments or claims.
...
> A new result should not be called `SUPPORTIVE` unless it survives relevant controls and was reasonably anticipated before the run.

## Acceptable Claim Forms

Prefer:

- "This finite scan found..."
- "This control failed before certificate lock..."
- "This metric remained correlated after the baseline..."
- "This result constrains the Origin reading because..."

Avoid:

- "This proves..."
- "The phenomenon is unique to primes..."
- "The Origin Frame explains this..." without a control and baseline.
- "The broader framework predicts..." unless the prediction is translated into a local test.

## Experiment Admission Checklist
...
- The result that would count as supportive.
- The result that would count as constraining or challenging.

If those cannot be named, keep the idea in notes rather than treating it as evidence.
